<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left" style="width:80%;">

      <el-container>
        <el-aside width="60%" style="background-color: #283443;">
          <img style="width: 100%;" src="./u235.svg">
        </el-aside>
        <el-main>
